...
<!--******************* JAVASCRIPT *******************-->
<!--**************************************************-->
<script src="js/administracion/citaAdmin.js"></script>
						...
						<div class="modal-header">
							<div class="row" align="center">
				  				<div class="col-xs-6 col-md-12">
									<h3 class="modal-title" style="color:#1B0082;text-align: center;">Solicitud de Cita Médica</h3>
								</div>
							</div>
						...
						<div class="modal-body" id="cuerpoModal">
							<div class="row" align="center">
				  				<div class="col-xs-12 col-md-12">
									<h4 style="color:#ff0000;text-align: center;">¿Desea solicitar la cita para el familiar?</h4>
								</div>
							</div>
						</div>
						<!-- Pie del Modal -->
